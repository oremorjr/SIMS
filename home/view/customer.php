				...
				<div class="row">
					<div class="box">
						<header>
							...
							<div><h5>Customers Dashboard</h5></div>
						</header>
										...
										<fieldset>
											...
											<div id="form-area"> 
												...
												<div class="form-group hidden">
													...
													<div class="col-lg-7">
														<input type="text" id="f2"  name="f2" class="first-input form-control">
													</div>
												</div>					  
							...
							<div class="col-lg-7">
								<div class="box inverse"  style="min-height:400px;">
									<header>
										...
										<div class="toolbar">
											<div class="btn-group">
												<a id="refresh" href="#defaultTable" data-toggle="collapse" title="Refresh list" alt="Refresh list"class="btn btn-sm btn-default minimize-box">
