	...
	$(document).ready(function(){
		...
		if(type==2){
			if(ID=='c_1'){
				...
				if(choice==1){
					window.location='?page=report&type=category&dr=today';
				}else if(choice==2){
					window.location='?page=report&type=category&dr=yesterday';
				}else if(choice==3){
					window.location='?page=report&type=category&dr=lastweek';
				}else if(choice==4){
					window.location='?page=report&type=category&dr=monthly';
				}else if(choice==5){
					window.location='?page=report&type=category&dr=annual';
				}else if(choice==6){
					window.location='?page=report&type=category&dr=lastyear';
				}
			}else if(ID=='c_2'){	
				var d1=$('#d_1').val();
				var d2=$('#d_2').val();
				window.location='?page=report&type=category&dr=range&d1='+d1+'&d2='+d2;
			}
		}
