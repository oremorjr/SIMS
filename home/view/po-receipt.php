...
<label>Supplier/Receipt No.</label>
</div>
...
<div class="col-lg-4 grid no-right">
  ...
  <?php
$rows=osd_query("osd_transaction", $where="t_active=0", "YEAR(t_transaction_date)");
$ynow=date('Y');
...
function search_receipt(string, year){
   $.ajax({
    ...
    url:'../include/function/pos/po-receipt-list-search.php',
