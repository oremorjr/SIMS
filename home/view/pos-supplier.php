  ...
  <div class="row">
    ...
    <table id="" class="  table table-bordered table-condensed table-hover table-striped">
     ...
     $gprofit=0;
      ...
      $q1=mysql_query("SELECT * from osd_transaction where  t_paid=1 and t_mode=2 order by t_receiptno DESC LIMIT 10 ");
      $profit=0;
      $sale=0;
      $show_sale=0;
      $show_profit=0;
   ...
   $show_sale=number_format($sale, 2, '.', ',');
      ?>
      <tr>
        <td><a href="?page=view-receipt-supplier&mode=2&TID=<?php echo $tid; ?>"><?php echo $tno;?></a></td>
        <td> <?php echo $or;?></td>
 ...
 $(document).ready(function(){
  show_result();
    ...
    function show_result(){
      jQuery.ajax({
        data: {slug: 'supplier'},
        url: 'view/view-result/supplier-list-home.php',
