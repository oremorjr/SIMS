			...
			$t=0;
			 ...
			 ?>
					...
					<tr>
						...
						<td width="20%" ><?php echo $OR;?></td> 
						<td width="25%" ><?php echo supplier('sup_name', $CID);?></td> 
						<td width="20%" class="right"><?php echo $show_t_amount;?></td> 
						<td class="none">
						<?php supplier_options($t_id, $CID);?>
						</td>
