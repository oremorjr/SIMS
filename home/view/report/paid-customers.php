...
$receipts=mysql_query("SELECT TID, t_receiptno, t_amount_t, t_trans_date, t_customer_id from osd_transaction where $qs t_mode=1 $q_s and t_complete=1 and t_return=0 and t_void=0 ");
...
<?php edit_sales_receipt($transID, $CID);?>
...
<?php customer_options($transID, $CID);?>
...
?>
<?php if(current_user('view-total-paid-invoices')):?>
