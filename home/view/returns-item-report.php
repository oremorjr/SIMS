  ...
  <div class="row">
    <div class="box">
      <header>
        ...
        <div>
          <h5>Returns Per Item Report Details</h5>
        </div>
           <div class="report-date"><?php echo $month_title; ?></div>
      </header>
 <ol class="breadcrumb mb-0">
  <li><a href="?page=general">General</a></li> 
  <li class="active">Returns Per Item Report Details</li>
</ol>
		 ...
		 $gprofit=0;
		  ...
		  while($row=mysql_fetch_array($q1)){
			...
			<tr class="receipt-date">
				...
				<td class="right none"><?php if(current_user('view-total-returns')):?><?php echo $show_sale;?><?php endif;?></td> 
			...
			$uname=unit('u_symbol', $UID);
			 ...
			 $t_profit=0;
			 $CID=get_customer_tid_bytransid($t_no, $td_mode);
			 ...
			 ?>
					...
					<tr>
						<td width="20%"  ><a href="#" class="show_receipt"  data-toggle="modal" data-target="#myModal"   id="<?php echo $TID;?>"><?php echo $t_no;?></a></td> 
