		...
		<div class="row">
			<div class="box">
				<header>
					...
					<div><h5>Suppliers Dashboard</h5></div>
				</header>


 <ol class="breadcrumb mb-0">
  <li><a href="?page=index">Sidebar</a></li> 
				...
				<div class="col-lg-5">
					...
					<img src="../images/loading_animation.gif" width="180">
                      ...
                      <div class="form-group hidden">
                        ...
                        <div class="col-lg-7">
                          <input type="text" id="f2"  name="f2" class="form-control">
                        </div>
                      </div>					  
                      <div class="form-group hidden">
                      ...
                      <div class="form-group hidden">
						...
						<div class="form-group">
                        <label class="control-label col-lg-4 required">Contact Number</label>
                          <div class="col-lg-7">
 						...
 						<div class="form-group">
                        <label class="control-label col-lg-4 required">Address 1</label>
                          <div class="col-lg-7 ">
                          <input type="text"  name="f6" class="form-control">
                        </div>
						</div> 
 						<div class="form-group hidden">
                        <label class="control-label col-lg-4 required">Address 2</label>
                          <div class="col-lg-7">
