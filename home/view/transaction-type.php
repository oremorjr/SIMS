...
<script type="text/javascript">
        ...
        function close_area(){
         $('.result-area').delay(5000).slideUp('fast');
        }
	function focus(){
	$(".first-input").focus();
	}
		...
		<div class="row">
			<div class="box">
				<header>
					...
					<div><h5>Transaction Type Dashboard</h5></div>
				</header>
				...
				<?php
				$count=0;
				if(current_user('add-transaction-type')):
				$count+=1;
				?>
				<div class="col-lg-5">
					<div class="box dark">
					...
					<img src="../images/loading_animation.gif" width="180">
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-4 required">Type</label>
                        <div class="col-lg-7">
			...
			<?php endif;?>
				...
				<!-- start results-->
				<?php
				if(current_user('view-transaction-type')):
				$count+=1;
				?>
				<div class="col-lg-7">
			...
			<?php endif;?>
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
				    <h3 class="panel-title"><strong>Transaction Type</strong></h3>
				  </div>
