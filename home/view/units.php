				...
				<div class="box dark">
					...
					<img src="../images/loading_animation.gif" width="180">
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-4 required" ><?php echo $slug;?> Name</label>
                        <div class="col-lg-7">
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-4 required"><?php echo $slug;?> Symbol</label>
                        <div class="col-lg-7">
			...
			<?php endif;?>
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
				    <h3 class="panel-title"><strong>Units</strong></h3>
				  </div>
