				...
				<header>
                    ...
                    <div class="toolbar">
                      <div class="btn-group">
                        ...
                        if($lock==0):
                          ?>
                        <a   href="?page=edit-pos-receivings&ID=<?php echo $customer;?>&TID=<?php echo $tid;?>"  class="btn btn-sm btn-default">
...
?>
                        <a   href="?page=void-receiving&ID=<?php echo $tid;?>"  class="btn btn-sm btn-default">
                         <i class="glyphicon glyphicon-plus-sign"></i> Void Transaction
                        </a>
                        <?php
                        endif;
                    }
                        ...
                        ?>	                       
                         <a   href="JavaScript:newPopup('view/print-preview-suppliers.php?mode=<?php echo $mode;?>&TID=<?php echo $tid;?>');"  class="btn btn-sm btn-default">
