		...
		<div class="row">
			<div class="box">
				<header>
					...
					<div><h5>Driver's Dashboard</h5></div>
				</header>
				<!-- start customer-->
				<div class="col-lg-5">
				<div class="box dark">
					...
					<img src="../images/loading_animation.gif" width="180">
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-4 required" >Truck No.</label>
                        <div class="col-lg-7">
                          <input type="text"  name="f1" class="first-input form-control all-caps">						  
