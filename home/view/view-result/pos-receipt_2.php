...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <div class="greeting bold t-center f-20">LUCKY VIEW MARKETING</div>
    <div class="greeting t-center">Cabanatuan City, Nueva Ecija</div>
    <div class="greeting t-center">0999-883-1428/0943-617-4127</div>
    <div class="greeting t-center">TIN 295-163-979</div>
  ...
  <tr> 
    ...
    <table border="0" width="100%">
      <tr>
        ...
        <td width="40%"class="b-line info ">&nbsp;<?php echo $cname;?></td>
        <td width="6%" class=" info right-2 ">DNO.</td>
        <td width="25%" class="b-line info">&nbsp;<strong><?php echo $receipt->tno;?></strong></td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="info left-2"> </td>
        <td class="info  "> </td>
        <td class="info right-2">TERMS </td>
        <td class="b-line info"> &nbsp;<?php echo transaction('t_COD', $tid);?></td>        
      </tr>   
  ...
  ?>
  <tr>
    <td width="8%" valign="top" class="right item"  >
    <?php echo $qty;?>  
    </td>
    <td width="8%" valign="top" class="t-center item">
     <?php echo $unit_name;?> 
    </td>   
...
?>
  ...
  <table border="0" width="50%" id="footer-table" style="float:left;">
    <tr>
      ...
      <tr>
      <td style="width:13%;">Driver: </td><td style="width:100%;border-bottom:1px solid #000;padding-left:10px;"> <?php echo $d_fname.' '.$d_lname;?></td>
      <td>&nbsp;</td><td>&nbsp;</td>
    </tr>    
      <tr>
  ...
  <table border="0" width="50%" id=" " style="float:left;">
