...
$receipts=mysql_query("SELECT TID, t_receiptno, t_amount_t, t_trans_date, t_supplier_id from osd_transaction where  $qs t_mode=$mode and t_complete=0 and t_return=0 and t_void=0 and t_active=0");
...
<td width="15%"><?php echo $customername;?></td>
