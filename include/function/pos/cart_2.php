...
$query1=mysql_query("SELECT TDID,p_name, td_pcode, p_pcode, ui_stocks, u_symbol, td_qty, ui_reorder_level, td_price, td_pu_logID, ui_reorder_level, td_disc, td_disc_l, td_total, ui_disc_rate, disc_status, ui_supplier_price, ui_base_price, ui_selling_price, p_brand
...
<!-- EDIT QTY -->
<script type="text/javascript" src="../js/pos/editqty_2.js"></script>
<!-- DELETE -->
