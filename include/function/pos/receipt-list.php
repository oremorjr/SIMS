...
<div class="col-lg-12 grid">
 ...
 <?php
$receipts=mysql_query("SELECT * from osd_transaction where t_receiptno LIKE '%$receipt%'  and t_mode=1   ");
...
<a href="?page=edit-pos&ID=<?php echo $customerID?>&TID=<?php echo $TID;?>"><?php echo $receiptno;?></a>
<?php else:?>
