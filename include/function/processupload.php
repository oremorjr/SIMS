...
if(isset($_POST))
{
	...
	$DestinationDirectory	= '../../images/uploads/'; //specify upload directory ends with / (slash)
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		$pid=$_REQUEST['pid'];
		mysql_query("UPDATE  osd_product  SET p_image_name='$NewImageName' WHERE PID=$pid");
