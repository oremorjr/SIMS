...
<?php
	...
	$query=mysql_query("SELECT * from osd_transaction_details where td_unit_id='$p_unitid'  and td_ispaid=0 and td_void=0 and td_pcode='$v1' and td_mode=1")or die(mysql_error());
...
<!--                           <th>PRICE</th>
                      ...
                      <tbody>
                        <tr> -->
                          <!-- <td><span class="show-code"> </td> -->
 <!--                          <td><span class="show-price"> </td>
                          <td><span class="show-qty">1</span></td>
                          <td><span class="show-total">1</span></td>
                        </tr>
...
<!-- 				
                  <header class="text-center">
                    <h5 style="font-weight:normal;"><?php echo $pname;?></h5>
                  </header> -->
...
<!--      	<div class="col-lg-4" style="margin:0;padding:0;position: relative;font-size:11px;">
	     <div class="">
...
<div class="image-holder">
		<img src="../images/uploads/thumb_<?php echo $image;?>">
	</div>
			</td>
		</tr>
		</table>
