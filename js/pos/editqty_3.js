...
data: {id:ID, lastname:last, tno:tno, sub_total:sub_total, disc:disc, price:price, disc_l:disc_l, td_total:td_total, mode_cart:mode_cart},
cache: false,
...
$("#preview_error").html('<pre>'+html+'</pre>');
